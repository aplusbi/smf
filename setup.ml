...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3abf8add5df113d9c87816fa50a4cb57) *)
(*
     ...
     package =
       {
          ...
          description = Some "OCaml bindings to smf";
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lsmf"])];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for smf";
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ocaml_portmidi", None);
                           InternalLibrary "ocaml_smf"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
